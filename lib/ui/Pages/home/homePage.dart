...
import 'package:mychat_app/ui/Pages/compenents/ListitleGroupe.dart';
import 'package:mychat_app/ui/Pages/searchPage.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(
              onPressed: () {
                navigate(context, const SearchPage());
              },
              icon: const Icon(
                Icons.search,
              ))
